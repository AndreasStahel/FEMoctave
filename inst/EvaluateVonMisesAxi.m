...
## -*- texinfo -*-
## @deftypefn{function file}{}@var{vonMises} = EvaluateVonMisesAxi(@var{sigma_x},@var{sigma_y},@var{sigma_z},@var{tau_xz})
##
...
function [vonMises] = EvaluateVonMisesAxi(sigma_x,sigma_y,sigma_z,tau_xz)
  vonMises = sqrt(0.5*((sigma_x-sigma_y).^2+(sigma_y-sigma_z).^2+(sigma_z-sigma_x).^2) + 3*tau_xz.^2);
endfunction
